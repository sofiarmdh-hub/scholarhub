...
$detail = get_detail_pendaftaran_beasiswa($conn, $id_pendaftaran);

if (!$detail) {
    echo "<script>alert('Data pendaftaran beasiswa tidak ditemukan!'); window.location='data-pendaftaran.php';</script>";
    exit();
}
            ...
            <div class="container-fluid px-3 px-lg-4 py-4">
                ...
                <div class="page-heading mb-4">
                    <div class="page-heading-copy">
                        ...
                        <div>
                            <p class="eyebrow mb-1">Validasi Berkas Akademik</p>
                            <h1 class="h3 mb-1">Periksa Pendaftaran Beasiswa</h1>
                            <p class="text-muted mb-0">Review dokumen pendaftaran beasiswa yang diajukan oleh mahasiswa.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card border-0 shadow-sm mb-4" style="border-radius: 16px;">
                            <div class="card-body p-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        <label class="text-muted small d-block">Program Beasiswa</label>
                                        <span class="fw-bold text-primary"><?= htmlspecialchars($detail['nama_beasiswa']); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-3 bg-light rounded-3 d-flex align-items-center justify-content-between mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <strong class="d-block text-dark">File Berkas Beasiswa</strong>
                                            <small class="text-muted">Format PDF / ZIP berkas syarat & transkrip</small>
                                        </div>
                                    </div>
                                    <?php if (!empty($detail['file_berkas'])): ?>
                                        <a href="../uploads/berkas_beasiswa/<?= $detail['file_berkas']; ?>" target="_blank" class="btn btn-sm btn-outline-primary fw-bold px-3" style="border-radius: 8px;">
                    ...
                    <div class="col-lg-4">
                        <div class="card border-0 shadow-sm" style="border-radius: 16px; border: 1px solid rgba(0,0,0,0.05);">
                            <div class="card-body p-4">
                                ...
                                <form action="../aksi/verifikasi-beasiswa-aksi.php" method="POST">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control" name="catatan" rows="4" placeholder="Tulis alasan penolakan atau catatan verifikasi di sini..." style="border-radius: 8px; font-size: 0.9rem;"><?= htmlspecialchars($detail['catatan_admin'] ?? ''); ?></textarea>
                                    </div>
